									...
									return A2(
										...
										function (reset) {
											return _elm_lang$core$Json_Decode$succeed(
												{x: x, y: y, rotation: rotation, thrust: thrust, reset: reset});
										},
										A2(_elm_lang$core$Json_Decode$field, 'reset', _elm_lang$core$Json_Decode$bool));
								},
...
var _user$project$Joystick$orientation = _elm_lang$core$Native_Platform.incomingPort(
	'orientation',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (x) {
...
var _user$project$Sensors$sensorMessagesPerSecond = 10;
...
var _user$project$App$controlDisplay = F2(
	function (xp, yp) {
		var middle = function (x) {
			return _elm_lang$core$Basics$toString(
				_elm_lang$core$Basics$floor(50 + (50 * x)));
							...
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return {phxSocket: a, mdl: b, messages: c, joystick: d, joystickIndex: e, sensorData: f, autoMode: g, selectedTab: h, parameters: i, lastClick: j, sending: k, accelerometer: l};
											};
										};
									};
								};
...
var _user$project$App$Orientation = function (a) {
	return {ctor: 'Orientation', _0: a};
};
var _user$project$App$ToggleOrientation = {ctor: 'ToggleOrientation'};
...
var _user$project$App$viewClickControl = function (data) {
	return A2(
		...
		{
			ctor: '::',
			_0: A2(_user$project$App$controlDisplay, data.x, data.y),
			_1: {ctor: '[]'}
		});
};
		...
		return A4(
			...
			model.mdl,
			{
				...
				_0: _MichaelCombs28$elm_mdl$Material_Textfield$onInput(
					_user$project$App$ChangeParameter(_p1._1)),
				_1: {
					ctor: '::',
				...
				_0: A2(
					...
					},
					{
						...
						_0: A5(
							...
							{
								ctor: '::',
								_0: _MichaelCombs28$elm_mdl$Material_Toggles$onClick(_user$project$App$ToggleOrientation),
								_1: {
									ctor: '::',
									_0: _MichaelCombs28$elm_mdl$Material_Toggles$value(model.accelerometer),
									_1: {ctor: '[]'}
								}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Enable accelerometer control'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							...
							_1: {
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _user$project$Joystick$orientation(_user$project$App$Orientation),
											_1: {ctor: '[]'}
										}
									}
								}
...
var _user$project$App$update = F2(
	function (msg, model) {
		...
		switch (_p9.ctor) {
			case 'PhoenixMsg':
				var _p10 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$update, _p9._0, model.phxSocket);
					...
					switch (_p11._0.ctor) {
								...
								_0: _elm_lang$core$Native_Utils.update(
									model,
									{
										messages: A2(
											...
											30,
											{ctor: '::', _0: _p11._0._0, _1: model.messages})
									}),
								_1: _elm_lang$core$Platform_Cmd$none
							};
						case 'AutoMessage':
							var _p13 = _p11._0._0;
							var _p12 = A2(_elm_lang$core$Debug$log, 'Auto mode set to ', _p13);
							return {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Native_Utils.update(
									model,
						...
						default:
							var newData = A2(
								...
								{ctor: '::', _0: _p11._0._0, _1: model.sensorData});
							return {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Native_Utils.update(
									model,
			...
			case 'UpdateControlDisplay':
				...
				if (_p14.ctor === 'Nothing') {
					...
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _user$project$Joystick$poll(_p14._0)
					};
				}
			...
			case 'GamepadConnected':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							joystickIndex: _elm_lang$core$Maybe$Just(_p9._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
					...
					_elm_lang$core$Json_Encode$object(
						{
							...
							_1: {ctor: '[]'}
						})) : {ctor: '_Tuple2', _0: model.phxSocket, _1: _elm_lang$core$Platform_Cmd$none};
			...
			case 'Orientation':
				var joy = model.joystick;
				var newJoy = model.accelerometer ? _elm_lang$core$Native_Utils.update(
					joy,
					{x: _p9._0.x, y: _p9._0.y}) : joy;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
