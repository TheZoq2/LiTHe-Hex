...
def get_right_angle(sensor_data):
    return math.atan(math.fabs(sensor_data.ir_front_right - sensor_data.ir_back_right)/DISTANCE_BETWEEN_SENSORS) 

def get_left_angle(sensor_data):
    return math.atan(math.fabs(sensor_data.ir_front_left - sensor_data.ir_back_left)/DISTANCE_BETWEEN_SENSORS)
