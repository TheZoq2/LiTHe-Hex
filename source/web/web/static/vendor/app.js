	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$svg$Svg_Attributes$x('48'),
				_elm_lang$svg$Svg_Attributes$y('0'),
				_elm_lang$svg$Svg_Attributes$width('4'),
...
var _user$project$Joystick$thrustRect = function (thrust) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$svg$Svg_Attributes$fill('#B0B0FF'),
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$Joystick$thrustRect(data.thrust),
						A2(
						_elm_lang$svg$Svg$circle,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$svg$Svg_Attributes$fill('#F0F9F0'),
						...
						_elm_lang$core$Native_List.fromArray(
							[])),
						_user$project$Joystick$steeringRect(data.rotation),
						A2(
						_elm_lang$svg$Svg$circle,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$svg$Svg_Attributes$fill('#FFB0B0'),
								_elm_lang$svg$Svg_Attributes$cx(
								middle(data.x)),
								_elm_lang$svg$Svg_Attributes$cy(
								middle(data.y)),
								_elm_lang$svg$Svg_Attributes$r('5')
							]),
						_elm_lang$core$Native_List.fromArray(
							[]))
					]))
				...
				function (y) {
					return A2(
						...
						function (rotation) {
							return A2(
								_elm_lang$core$Json_Decode$andThen,
								A2(_elm_lang$core$Json_Decode_ops[':='], 'thrust', _elm_lang$core$Json_Decode$float),
								function (thrust) {
...
var _user$project$Sensors$h = 450;
var _user$project$Sensors$w = 900;
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$svg$Svg_Attributes$d(area),
								_elm_lang$svg$Svg_Attributes$stroke('none'),
								_elm_lang$svg$Svg_Attributes$strokeWidth('3px'),
								_elm_lang$svg$Svg_Attributes$fill('rgba(255, 0, 0, 0.54)')
							]),
						_elm_lang$core$Native_List.fromArray(
							[])),
						A2(
...
var _user$project$App$viewBody = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Joystick$joystickDisplay(model.joystick),
				A2(_elm_lang$html$Html_Lazy$lazy, _user$project$Sensors$viewSensor, model.sensorData),
				A2(
				_elm_lang$html$Html$form,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onSubmit(_user$project$App$SendMessage)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A4(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_debois$elm_mdl$Material_Textfield$onInput(_user$project$App$SetNewMessage),
								_debois$elm_mdl$Material_Textfield$value(model.currentMessage)
							]))
					])),
				A2(
				_elm_lang$html$Html$div,
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$App$messageList(model.messages)
					]))
			]));
};
var _user$project$App$view = function (model) {
	return A4(
		...
		model.mdl,
		_elm_lang$core$Native_List.fromArray(
			[_debois$elm_mdl$Material_Layout$fixedHeader, _debois$elm_mdl$Material_Layout$scrolling]),
		{
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$src('/images/logo_small.png')
								]),
							_elm_lang$core$Native_List.fromArray(
								[])),
							_elm_lang$html$Html$text('LiTHe Hex')
						]))
				]),
...
var _user$project$App$init = function (_p0) {
	...
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		{
			...
			sensorData: _elm_lang$core$Native_List.fromArray(
				[
					{
					ctor: '_Tuple2',
					_0: _elm_lang$core$Date$fromTime(1448928000000),
				...
				if (_p5.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								messages: A2(_elm_lang$core$List_ops['::'], _p5._0.body, model.messages)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
...
var _user$project$App$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$listen, model.phxSocket, _user$project$App$PhoenixMsg),
				_user$project$Joystick$axisData(_user$project$App$AxisData),
				_user$project$Joystick$connected(_user$project$App$GamepadConnected),
				_user$project$Joystick$disconnected(_user$project$App$GamepadDisconnected),
				A2(_elm_lang$core$Time$every, _elm_lang$core$Time$millisecond * 10, _user$project$App$UpdateControlDisplay),
				A2(_elm_lang$core$Time$every, _elm_lang$core$Time$millisecond * 500, _user$project$App$SendControlToServer)
			]));
};
