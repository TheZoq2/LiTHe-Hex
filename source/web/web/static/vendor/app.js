...
var _user$project$App$Model = F4(
	function (a, b, c, d) {
		return {phxSocket: a, currentMessage: b, messages: c, mdl: d};
	});
			...
			[_debois$elm_mdl$Material_Layout$fixedHeader]),
		{
			header: _elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Emiluren.se')
						]))
				]),
...
var _user$project$App$init = function () {
	...
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		{phxSocket: phxSocket, currentMessage: '', messages: _elm_lang$core$Array$empty, mdl: _debois$elm_mdl$Material$model},
		_elm_lang$core$Native_List.fromArray(
			[
