...
\begin{document}
  ...
  \newpage
	...
	I2C port finns på sensorenheten. 
	% TODO motivera varför SPI är mest aktuellt, LIDAR laser borde inte påverka 
	% möjligheten till I2C eftersom den kan anslutas till samma buss. 
