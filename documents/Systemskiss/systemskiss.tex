...
\begin{document}
  ...
  för att fatta beslut. Detta innebär att centralenheten antingen blir avbruten
  mitt i en funktion för att behandla ny data eller att sensordata ignoreras.
