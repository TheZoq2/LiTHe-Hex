...
\begin{document}
	...
	\section{Inledning}
	I detta dokument beskrivs funktionaliteten produkten kommer 
	...
	\subsection{Parter}
	%Projektets parter utgörs av beställare och kund Tomas Svensson, lektor vid Linköpings
	%tekniska högskola, samt producent projektgrupp 9, bestående av 7 studenter från 
	%D-programmet vid Linköpings tekniska högskola. 
  ...
  \newpage
	...
	kommunikation till omvärlden via WiFi. Denna utgörs av en Raspberry
	...
	servopositioner till de individuella servona. Benkontrollern ska även kunna skicka data om underlagets
