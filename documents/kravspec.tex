	...
	\begin{center}
		...
		\begin{table}[h]
			\begin{tabular}[pos]{| l | l | l | l | l |}
				...
				0.1 & 2016-09-07 & Första utkastet & Projektgruppen & \\ \hline
  ...
  \newpage
	...
	\begin{table}[h]
		...
		\begin{tabularx}{\textwidth}{|c|l|X|l|}
			...
			\nextReqNr & Original & Centralenheten ska kunna ta emot sensordata från, 
			...
			\nextReqNr & Original & Centralenheten ska kunna använda datan från
				sensor- och motorikenheten för att navigera i banan & 2
				\\ \hline
