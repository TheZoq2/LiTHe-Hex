  ...
  \newpage
	...
	%\begin{table}[h]
		\begin{longtable}[c]{ c l>{\raggedright}p{0.6\textwidth} l }
			...
			\nextReqNrII{} & \newRequirement{2016--09--09} & Via WiFi ska roboten kunna reagera på följande
	...
	\begin{longtable}[c]{ c l>{\raggedright}p{0.6\textwidth} l }
		...
		\arabic{reqNr}A & \newContent{2016--09--09} & Motorikenheten ska möjliggöra rörelse åt höger
			och vänster. & 1
	...
	\begin{longtable}[c]{ c l>{\raggedright}p{0.6\textwidth} l }
		...
		\nextReqNrII{} & \newRequirement{2016--09--09} & Robotens regleralgoritms styrparametrar
	...
	\begin{longtable}[c]{ c l>{\raggedright}p{0.6\textwidth} l }
		...
		\nextReqNrII{} & \newRequirement{2016--09--09} & Tidrapporter ska lämnas in på förbestämda datum.  & 1
			\\ \midrule
