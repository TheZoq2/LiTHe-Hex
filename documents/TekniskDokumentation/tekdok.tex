...
\listoftodos
	...
	center för roboten efter förflyttning) angivet i meter, med x-coordinat fram och 
	y-coordinat åt vänster om roboten, med origo i robotens mittpunkt. Om totalavståndet 
	origo till målposition är mindre än 1 (m) skalas rörelsen ned utifrån detta avstånd. 
	Det vill säga, om roboten ombeds gå 0,5 meter frammåt, tar den ett kliv med halva 
