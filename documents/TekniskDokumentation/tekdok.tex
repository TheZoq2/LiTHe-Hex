...
\listoftodos
  ...
  verkar. Vid manuell styrning vidarebefordras endast data från styrdatorn.
    ...
    För den manuella navigationen används sockets mellan webbservern
    ...
    Kommunikation nedan %TODO: add reference to the subsection
    ...
    uppdaterade data:n med hjälp av JSON. Det finns också en eller flera grafer
    ...
    webbläsaren för att visualisera den inverterade kinematiken.
