...
\listoftodos
  ...
  fysiska knappen eller knappen i användargränssnittet.
	...
	Vidare beskrivs nedan förenklat funktionaliteten för work_towards_goal i gangstil.c, i pseudokoden skriven 
	som take_one_step_in_requested_direction för tydlighet:
