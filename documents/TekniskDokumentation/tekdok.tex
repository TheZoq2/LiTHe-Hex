...
\listoftodos
  ...
  verkar. Vid manuell styrning vidarebefordras endast data från styrdatorn.
	...
	\begin{longtable}[c]{ l l l }
		...
		Sätt servohastighet & 20 & 8 LSB, 8 MSD \\ \midrule
		...
		Behandlad sensordata & 24 & len, ... avståndsmätardata ..., gyrodata \\ \midrule
		Korridordata		 & 25 & len, ... avstånd till väggar ..., vinkel \\
    ...
    \todo{Lägg till pseudokod för beslutsfattning}%
