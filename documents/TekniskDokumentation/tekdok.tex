...
\listoftodos
	...
	varsin SPI-port på Raspberry PI:en. Detta illustreras i figur \ref{fig:central_circuit}.
	...
	center för roboten efter förflyttning) angivet i meter, med x-koordinat fram och 
	y-koordinat åt vänster om roboten, med origo i robotens mittpunkt. Om totalavståndet 
	origo till målposition är mindre än 1 (m) skalas rörelsen ned utifrån detta avstånd. 
	Det vill säga, om roboten ombeds gå 0,5 meter framåt, tar den ett kliv med halva 
	steglängden av om den ombetts gå en meter, även om inget av kliven är i närheten av 
	de respektive distanserna; om en enmetersdistans (maximal steglängd) leder till ett 
	1,6 decimeters kliv, leder halvmetersdistansen till ett ca: 0.8 decimeters kliv i samma 
	startposition. 
	
	Vidare ges den rotation som roboten 
	skall rotera, angiven i radianer positiv vänster med 0 rad frammåt, och en flagga för om 
