...
\listoftodos
    ...
    För att ändra vilket läge roboten ska köras i finns en knapp som växlar dess läge.
        ...
        \subsubsection{Autonomt läge}
        Användaren klickar på en knapp som sätter roboten i autonomt läge. Detta beskrivs i sektion \ref{sec:central-autonom}.
	...
	\begin{longtable}[c]{l l l l}
		...
		Gångstil & Olav Övrebö & & \\ 
		Kommunikation med SPI & Malcolm Vigren, Noak Ringman & & \\ 
		Webbserver/GUI & Emil Segerbäck, Hannes Tuhkala & & \\ 
		Beslutsfattning & Robin Sliwa, Noak Ringman & & \\ 
		PID-reglering & Robin Sliwa, Olav Övrebö & & \\ 
		Motorik & Olav Övrebö, Frans Skarman & & \\ 
		Servokontroll & Frans Skarman & & \\ 
