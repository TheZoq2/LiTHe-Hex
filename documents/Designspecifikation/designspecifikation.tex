...
\begin{document}
  ...
  verkar. Vid manuell styrning vidarebefordras endast data från styrdatorn.
	...
	SPI-port med varsin chip select. All kommunikation kommer att inledas med att 
    ...
    Figur \ref{fig:schem_sensor} visar kretschema över sensorenheten.
    ...
    "IR-kö". Så länge denna kö är tom, användanväanvändslaren för att
