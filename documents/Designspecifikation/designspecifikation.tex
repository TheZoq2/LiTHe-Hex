...
\begin{document}
	...
	Simuleringen går till genom att implementera algoritmen för 2D som beskrivs i avsnittet \ref{inverterad-kinematik} Inverterad Kinematik. Simuleringen ritas sedan ut i webbläsaren för att visualisera den inverterade kinematiken.
