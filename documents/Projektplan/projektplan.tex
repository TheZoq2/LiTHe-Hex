...
\begin{document}
  ...
  Kontaktdata: Rum 3B:528 013–28 13 68 tomas.svensson@liu.se
    ...
    \begin{longtable}[l]{ p{2.3cm} p{2.1cm} p{4cm} p{2.2cm} l }
        ...
        System- skiss & Beställare & Grov skiss och idéer för 
        implementation av systemet & Beställare & 2016--09--29 \\ \midrule

        Design- specifikation & Handledare & Detaljerad beskrivning av
