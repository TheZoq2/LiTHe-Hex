%% TODO%% TODO%% TODO%% TODO%% TODO%% TODO%% TODO%% TODO%% TODO%% TODO%% TODO		   k
% Milstolpar, material, utveklingsmetodik, tidsplan, simuleringark
% 
...
\begin{document}
	...
	\begin{center}
		...
		\begin{longtable}[c]{ l l l l l }
			...
			0.3 & 2016--09--28 & Tredje utkastet &  & \\
		\end{longtable}
	\end{center}
  ...
  projektgrupp ska konstruera en sexbent robot. 
	...
	Tids- och statusrapporter ska skrivas och skickas in följande datum innan kl 16:00: 31--10--2016, 7--11--2016, 14--11--2016, 21--11--2016, 28--11--2016, 5--12--2016, 12--12--2016 och 19--12--2016. Detta görs lämpligen
	...
	\begin{longtable}[c]{ c p{4cm} p{6cm} p{2cm} p{2cm}}
		...
		\nextAktNr{} & Enhetskonvertering & Enhetstestning av sensorenheten &  & 5 \\ \midrule
		...
		\nextAktNr{} & Buffertid & Tiden som kan användas där den behövs &  & 168 \\ \midrule
