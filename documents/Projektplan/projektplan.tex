...
\begin{document}
  ...
  projektgrupp ska konstruera en sexbent robot. 
	...
	\begin{longtable}[l]{ p{3cm} p{3cm} >{\raggedright}p{5cm} p{2.2cm} l }
		...
		Projektplan & Handledare & Beskrivning av hur projektet ska genomföras & 2016--09--29 \\ \midrule

		Tidplan & Beställare & Planering för hur arbetstid ska fördelas. & 2016--09--29  \\ \midrule
		
		Systemskiss & Handledare & Grov skiss och idéer för implementation av systemet & 2016--09--29 \\ \midrule
